...
public class ShowCompAddr {
	...
	//친구 회사 근천에서 점심을 먹기로 했다
	//친구 회사 주소를 보여주는 메소드 작성
	public static void showCompAdder(Friend f) {
		String addr = null;
		if(f != null) {
			Company com = f.getCmp();
			//70% 일을 쉬고 있어서 회사 정보가 ㅇ벗다
			if(com != null) {
		...
		if(addr != null) {
			...
			System.out.println("There's no address inforamtion.");
		}
	}
	...
	public static void main(String[] args) {
		...
		//=> 이를 해결하기 위해ㅔ 등장한 것이 Optional클래스
	}
